...
Generated by 'djangocms' command using django CMS 5.0.5 and Django 6.0.
...
SECRET_KEY = 'django-insecure-l8+v&xywve*&k#k8qryi&3k)me7g8)%d_stym%)o&glwq^t%#u'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "practiceProject", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    BASE_DIR / "practiceProject" / "static",
]
