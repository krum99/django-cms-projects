"""
Django settings for commonPlugins project.

Generated by 'djangocms' command using django CMS 5.0.5 and Django 5.2.10.
...
SECRET_KEY = 'django-insecure-rvy0h23i1sc8-(#q6ntst!_vzt&lw(csittli1fq***agcd3ya'
...
ROOT_URLCONF = 'commonPlugins.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "commonPlugins", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'commonPlugins.wsgi.application'
